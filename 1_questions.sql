...
where special_features like "%behind the scenes%" and length <120 and
...
------> select c.first_name,c.last_name,a.first_name,a.last_name from customer c join actor a on c.last_name =a.last_name;
